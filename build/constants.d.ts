...
export declare const DEFAULT_IDENTIFICATION_QUESTION = "Please enter your name or an indentifier for your response for this survey:";
export declare const DEFAULT_INTRODUCTION = "Please fill in this survey.";
export declare const DEFAULT_FINISH_SURVEY_MESSAGE = "Thank you for taking this survey! Your response has been recorded. You can now safely close the window.";
